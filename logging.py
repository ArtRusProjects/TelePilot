...
# if the module micropython is not available do the mapping of const func
def const(input):
    return input
...
class Formatter:
    ...
    def formatTime(self, datefmt, record):
        # print(datetime.strftime(datefmt, time.localtime(record.ct)))
        # if hasattr(time, "strftime"):
        #     return time.strftime(datefmt, time.localtime(record.ct))
        # return None

        # MicroPython has no time.strftime so here is workaround
